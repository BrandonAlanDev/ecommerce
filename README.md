# Gestion stock - Next.js & Prisma

Este proyecto es una aplicación web moderna para gestionar stocks, construida con **Next.js 16**, autenticación robusta mediante **Auth.js** (Google OAuth + Credenciales), y base de datos MySQL gestionada con **Prisma ORM 7**.
...
```bash
git clone https://github.com/BrandonAlanDev/gestion-stock.git
cd gestion-stock
```
...
2.  Arriba a la izquierda, haz clic en el selector de proyectos y selecciona **"Nuevo Proyecto"**. Ponle un nombre (ej: `Stock app`) y créalo.
