    ...
    <section className="max-w-7xl mx-auto px-4 mb-16 mt-16">
      <div className="bg-slate-900 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-slate-900/20">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-30">
          ...
          <div className="absolute left-0 bottom-0 w-96 h-96 bg-purple-500 rounded-full blur-[100px] -translate-x-1/2 translate-y-1/2"></div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <h3 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">
            Calzado que no falla.
          </h3>
          <p className="text-slate-300 mb-8 max-w-lg mx-auto text-lg leading-relaxed">
            Descubre nuestra selección de botines de fútbol de alta calidad, diseñados para ofrecerte el mejor rendimiento en la cancha. Con tecnología avanzada y estilos modernos, nuestros botines te ayudarán a dominar el juego con comodidad y estilo.
          </p>
          <a href="/productos">
    ...
    <section id="featured" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
        <div className='flex flex-col p-5'>
          <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Destacados</h2>
          <p className="text-slate-500 mt-2 text-lg">La mejor del deporte.</p>
        </div>
        
        {/* Aquí integramos el CategoryFilter que mencionaste */}
